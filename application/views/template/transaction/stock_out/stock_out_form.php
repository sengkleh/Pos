...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        ...
        <a href="<?php echo site_url('Ctr_stock/out')?>" class ="btn btn-primary btn-sm mb-2 mt-6"><i class="fa fa-arrow-left" aria-hidden="true"></i></i> Back</a>
        </div>
                                    ...
                                    <div class="ln_solid">
                                        <div class="form-group">
                                            <div class="col-md-6 offset-md-3 mt-3">
                                                <button type='submit' name="out_add" id="out_add" class="btn btn-app btn-md"><i class="fa fa-paper-plane" aria-hidden="true"></i> Submit</button>
